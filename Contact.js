...
const Contact = () => {
  return (
    ...
    <div class="grid  grid-cols-1 md:grid-cols-12 border-2 rounded">
        <div class=" md:col-span-4 p-10 text-white">
            ...
            <p class="mt-4 leading-7 ">
              Have a great project in mind? Dont hesistate to reach out to me via email, phone number or even send me a message on the email form.
            </p>

            <div class="flex items-center mt-16">
            <span class="  text-[red]  text-[20px] mr-2"><FaEnvelope/></span> 

                <span class="text-sm">Bethwelnjenga83@gmail.com</span>
            </div>
            <div class="flex items-center mt-5">
            <span class="  text-[red]  text-[20px] mr-2"><FaPhone/></span>  
